...
final class SearchCityHeaderView: UIView {
    ...
    private func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            self.searchBar.topAnchor.constraint(equalTo: self.safeAreaLayoutGuide.topAnchor, constant: 8.0),
